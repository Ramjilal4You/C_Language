...
// function prototypes array container functions 
...
void insertItem(dynamic_array* container, int item)
{
	if (container->size == container->capacity) {
		...
		container->capacity <<= 1;	//container->capacity = container->capacity << 1;
		container->array = realloc(container->array, 2 * container->capacity * sizeof(int));
		if (!container->array) {
